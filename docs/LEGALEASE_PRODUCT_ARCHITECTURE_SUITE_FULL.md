...
# Appendix V — Complete API Route Catalog (Auto-Generated)

This appendix lists **493 HTTP/WebSocket routes** extracted from the LegalEase FastAPI codebase. Base URL: `/api/v1`. Authentication: Bearer JWT unless marked Public.
...
| GET | `/api/v1/account/export` | JWT |
| POST | `/api/v1/account/forgot-password` | JWT |
| GET | `/api/v1/account/onboarding` | JWT |
| POST | `/api/v1/account/onboarding/dismiss` | JWT |
| GET | `/api/v1/account/preferences` | JWT |
| PATCH | `/api/v1/account/preferences/learner-mode` | JWT |
| POST | `/api/v1/account/reset-password/{token}` | JWT |
| POST | `/api/v1/account/verify-email/confirm` | JWT |
| POST | `/api/v1/account/verify-email/send` | JWT |
...
### `POST /api/v1/account/onboarding/dismiss`
...
### `PATCH /api/v1/account/preferences/learner-mode`
...
### `POST /api/v1/account/verify-email/confirm`
...
### `POST /api/v1/account/verify-email/send`
...
| Method | Full Path | Auth |
|--------|-----------|------|
| GET | `/api/v1/admin/audit` | Superadmin |
| GET | `/api/v1/admin/health` | Superadmin |
| GET | `/api/v1/admin/usage` | Superadmin |
| GET | `/api/v1/admin/users` | Superadmin |
| POST | `/api/v1/admin/users/{user_id}/plan` | Superadmin |
| POST | `/api/v1/admin/users/{user_id}/suspend` | Superadmin |
| POST | `/api/v1/admin/users/{user_id}/unsuspend` | Superadmin |
...
| Method | Full Path | Auth |
|--------|-----------|------|
| GET | `/api/v1/billing/collections` | JWT |
| GET | `/api/v1/billing/entries` | JWT |
| POST | `/api/v1/billing/entries` | JWT |
| POST | `/api/v1/billing/entries/bulk` | JWT |
| PUT | `/api/v1/billing/entries/{record_id}` | JWT |
| DELETE | `/api/v1/billing/entries/{record_id}` | JWT |
| POST | `/api/v1/billing/entries/{record_id}/duplicate` | JWT |
| GET | `/api/v1/billing/expenses` | JWT |
| POST | `/api/v1/billing/expenses` | JWT |
| DELETE | `/api/v1/billing/expenses/{expense_id}` | JWT |
| GET | `/api/v1/billing/invoices` | JWT |
| POST | `/api/v1/billing/invoices` | JWT |
| POST | `/api/v1/billing/invoices/compute-totals` | JWT |
| POST | `/api/v1/billing/invoices/draft` | JWT |
| GET | `/api/v1/billing/invoices/prefill` | JWT |
| GET | `/api/v1/billing/invoices/{invoice_id}` | JWT |
| PUT | `/api/v1/billing/invoices/{invoice_id}` | JWT |
| POST | `/api/v1/billing/invoices/{invoice_id}/finalize` | JWT |
| GET | `/api/v1/billing/invoices/{invoice_id}/pdf` | JWT |
| PATCH | `/api/v1/billing/invoices/{invoice_id}/status` | JWT |
| GET | `/api/v1/billing/matter/{matter_id}/financials` | JWT |
| GET | `/api/v1/billing/matter/{matter_id}/profile` | JWT |
| PUT | `/api/v1/billing/matter/{matter_id}/profile` | JWT |
| POST | `/api/v1/billing/narrative/correct` | JWT |
| POST | `/api/v1/billing/narrative/preview` | JWT |
| GET | `/api/v1/billing/payments` | JWT |
| GET | `/api/v1/billing/plans` | JWT |
| GET | `/api/v1/billing/reports/{report_type}` | JWT |
| GET | `/api/v1/billing/status` | JWT |
| GET | `/api/v1/billing/summary` | JWT |
| GET | `/api/v1/billing/workspace` | JWT |
...
### `POST /api/v1/billing/entries/bulk`
...
### `PUT /api/v1/billing/entries/{record_id}`
...
### `DELETE /api/v1/billing/entries/{record_id}`
...
### `POST /api/v1/billing/entries/{record_id}/duplicate`
...
### `DELETE /api/v1/billing/expenses/{expense_id}`
...
### `POST /api/v1/billing/invoices/compute-totals`
...
### `GET /api/v1/billing/invoices/prefill`
...
### `PATCH /api/v1/billing/invoices/{invoice_id}/status`
...
### `GET /api/v1/billing/matter/{matter_id}/financials`
...
### `GET /api/v1/billing/matter/{matter_id}/profile`
...
### `PUT /api/v1/billing/matter/{matter_id}/profile`
...
### `POST /api/v1/billing/narrative/correct`
...
### `POST /api/v1/billing/narrative/preview`
...
### `GET /api/v1/billing/reports/{report_type}`
...
| POST | `/api/v1/chat/export-report` | JWT |
| POST | `/api/v1/chat/stream` | JWT |
...
| POST | `/api/v1/clauses/feedback` | JWT |
...
| Method | Full Path | Auth |
|--------|-----------|------|
| GET | `/api/v1/collaboration/attachments/{attachment_id}/download` | JWT |
| GET | `/api/v1/collaboration/debug/realtime` | JWT |
| GET | `/api/v1/collaboration/members` | JWT |
| POST | `/api/v1/collaboration/messages/{message_id}/create-deadline` | JWT |
| POST | `/api/v1/collaboration/messages/{message_id}/create-task` | JWT |
| GET | `/api/v1/collaboration/notifications` | JWT |
| POST | `/api/v1/collaboration/notifications/{notification_id}/read` | JWT |
| GET | `/api/v1/collaboration/permissions` | JWT |
| POST | `/api/v1/collaboration/presence` | JWT |
| GET | `/api/v1/collaboration/presence` | JWT |
| GET | `/api/v1/collaboration/requests` | JWT |
| POST | `/api/v1/collaboration/requests` | JWT |
| POST | `/api/v1/collaboration/requests/{request_id}/accept` | JWT |
| POST | `/api/v1/collaboration/requests/{request_id}/reject` | JWT |
| GET | `/api/v1/collaboration/rooms` | JWT |
| POST | `/api/v1/collaboration/rooms/channel` | JWT |
| POST | `/api/v1/collaboration/rooms/dm` | JWT |
| GET | `/api/v1/collaboration/rooms/matter/{matter_id}` | JWT |
| GET | `/api/v1/collaboration/rooms/{room_id}` | JWT |
| GET | `/api/v1/collaboration/rooms/{room_id}/context` | JWT |
| GET | `/api/v1/collaboration/rooms/{room_id}/messages` | JWT |
| POST | `/api/v1/collaboration/rooms/{room_id}/messages` | JWT |
| POST | `/api/v1/collaboration/rooms/{room_id}/messages/{message_id}/attachments` | JWT |
| POST | `/api/v1/collaboration/rooms/{room_id}/messages/{message_id}/reactions` | JWT |
| POST | `/api/v1/collaboration/rooms/{room_id}/read` | JWT |
| GET | `/api/v1/collaboration/rooms/{room_id}/stats` | JWT |
| GET | `/api/v1/collaboration/rooms/{room_id}/stream` | JWT |
| POST | `/api/v1/collaboration/rooms/{room_id}/summarize` | JWT |
| GET | `/api/v1/collaboration/rooms/{room_id}/typing` | JWT |
| GET | `/api/v1/collaboration/search` | JWT |
| POST | `/api/v1/collaboration/typing` | JWT |
| GET | `/api/v1/collaboration/users/search` | JWT |
| WEBSOCKET | `/api/v1/collaboration/ws` | JWT |

### `GET /api/v1/collaboration/attachments/{attachment_id}/download`
...
### `GET /api/v1/collaboration/debug/realtime`
...
### `POST /api/v1/collaboration/messages/{message_id}/create-deadline`
...
### `POST /api/v1/collaboration/messages/{message_id}/create-task`
...
### `GET /api/v1/collaboration/permissions`
...
### `POST /api/v1/collaboration/requests/{request_id}/accept`
...
### `POST /api/v1/collaboration/requests/{request_id}/reject`
...
### `POST /api/v1/collaboration/rooms/dm`
...
### `GET /api/v1/collaboration/rooms/matter/{matter_id}`
...
### `GET /api/v1/collaboration/rooms/{room_id}`
...
### `GET /api/v1/collaboration/rooms/{room_id}/context`
...
### `GET /api/v1/collaboration/rooms/{room_id}/messages`
...
### `POST /api/v1/collaboration/rooms/{room_id}/messages`
...
### `POST /api/v1/collaboration/rooms/{room_id}/messages/{message_id}/attachments`
...
### `POST /api/v1/collaboration/rooms/{room_id}/messages/{message_id}/reactions`
...
### `POST /api/v1/collaboration/rooms/{room_id}/read`
...
### `GET /api/v1/collaboration/rooms/{room_id}/stats`
...
### `GET /api/v1/collaboration/rooms/{room_id}/stream`
...
### `POST /api/v1/collaboration/rooms/{room_id}/summarize`
...
### `GET /api/v1/collaboration/rooms/{room_id}/typing`
...
### `POST /api/v1/collaboration/typing`
...
### `GET /api/v1/collaboration/users/search`
...
| GET | `/api/v1/crm` | JWT |
| POST | `/api/v1/crm` | JWT |
| GET | `/api/v1/crm/analytics` | JWT |
| POST | `/api/v1/crm/assistant` | JWT |
| POST | `/api/v1/crm/classify` | JWT |
| GET | `/api/v1/crm/command-center` | JWT |
| GET | `/api/v1/crm/dashboard` | JWT |
| POST | `/api/v1/crm/intent/correct` | JWT |
| GET | `/api/v1/crm/kanban` | JWT |
| GET | `/api/v1/crm/permissions` | JWT |
| GET | `/api/v1/crm/pipeline-stages` | JWT |
| GET | `/api/v1/crm/{lead_id}` | JWT |
| PATCH | `/api/v1/crm/{lead_id}` | JWT |
| POST | `/api/v1/crm/{lead_id}/analyze` | JWT |
| POST | `/api/v1/crm/{lead_id}/archive` | JWT |
| GET | `/api/v1/crm/{lead_id}/audit` | JWT |
| POST | `/api/v1/crm/{lead_id}/convert` | JWT |
| POST | `/api/v1/crm/{lead_id}/convert-to-matter` | JWT |
| POST | `/api/v1/crm/{lead_id}/convert/preview` | JWT |
| GET | `/api/v1/crm/{lead_id}/documents` | JWT |
| POST | `/api/v1/crm/{lead_id}/documents` | JWT |
| POST | `/api/v1/crm/{lead_id}/follow-up/apply` | JWT |
| POST | `/api/v1/crm/{lead_id}/follow-up/preview` | JWT |
| POST | `/api/v1/crm/{lead_id}/follow-up/send` | JWT |
| GET | `/api/v1/crm/{lead_id}/follow-up/templates` | JWT |
| GET | `/api/v1/crm/{lead_id}/interactions` | JWT |
| POST | `/api/v1/crm/{lead_id}/interactions` | JWT |
| POST | `/api/v1/crm/{lead_id}/reject` | JWT |
| PATCH | `/api/v1/crm/{lead_id}/stage` | JWT |
...
### `POST /api/v1/crm/intent/correct`
...
### `POST /api/v1/crm/{lead_id}/analyze`
...
### `POST /api/v1/crm/{lead_id}/archive`
...
### `POST /api/v1/crm/{lead_id}/convert`
...
### `POST /api/v1/crm/{lead_id}/convert-to-matter`
...
### `POST /api/v1/crm/{lead_id}/convert/preview`
...
### `GET /api/v1/crm/{lead_id}/documents`
...
### `POST /api/v1/crm/{lead_id}/documents`
...
### `POST /api/v1/crm/{lead_id}/follow-up/apply`
...
### `POST /api/v1/crm/{lead_id}/follow-up/preview`
...
### `POST /api/v1/crm/{lead_id}/follow-up/send`
...
### `GET /api/v1/crm/{lead_id}/follow-up/templates`
...
### `GET /api/v1/crm/{lead_id}/interactions`
...
### `POST /api/v1/crm/{lead_id}/interactions`
...
### `POST /api/v1/crm/{lead_id}/reject`
...
### `PATCH /api/v1/crm/{lead_id}/stage`
...
| POST | `/api/v1/documents/index` | JWT |
| GET | `/api/v1/documents/jobs` | JWT |
| GET | `/api/v1/documents/jobs/{job_id}` | JWT |
| GET | `/api/v1/documents/kb/health` | JWT |
| POST | `/api/v1/documents/kb/reindex-auto` | JWT |
| POST | `/api/v1/documents/kb/smoke-test` | JWT |
| POST | `/api/v1/documents/kb/sync-status` | JWT |
| POST | `/api/v1/documents/upload` | JWT |
| DELETE | `/api/v1/documents/{doc_id}` | JWT |
| GET | `/api/v1/documents/{doc_id}/entities` | JWT |
| GET | `/api/v1/documents/{doc_id}/timeline` | JWT |
...
### `GET /api/v1/documents/kb/health`
...
### `POST /api/v1/documents/kb/reindex-auto`
...
### `POST /api/v1/documents/kb/smoke-test`
...
### `POST /api/v1/documents/kb/sync-status`
...
## Module: drafting_studio

| Method | Full Path | Auth |
|--------|-----------|------|
| POST | `/api/v1/drafting/smart-draft/generate` | JWT |
| GET | `/api/v1/drafting/smart-draft/types` | JWT |
| GET | `/api/v1/drafting/smart-draft/{draft_type}/questions` | JWT |

### `POST /api/v1/drafting/smart-draft/generate`
...
### `GET /api/v1/drafting/smart-draft/types`
...
### `GET /api/v1/drafting/smart-draft/{draft_type}/questions`
...
| Method | Full Path | Auth |
|--------|-----------|------|
| POST | `/api/v1/drafting/redline` | JWT |
| POST | `/api/v1/drafting/redline/feedback` | JWT |
| GET | `/api/v1/drafting/workspace/documents/{draft_id}/audit` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/autofill` | JWT |
| GET | `/api/v1/drafting/workspace/documents/{draft_id}/clause-intel` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/comments/{comment_id}/resolve` | JWT |
| GET | `/api/v1/drafting/workspace/documents/{draft_id}/compare-v3` | JWT |
| PATCH | `/api/v1/drafting/workspace/documents/{draft_id}/content` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/copilot` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/export-v3` | JWT |
| GET | `/api/v1/drafting/workspace/documents/{draft_id}/insights` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/status` | JWT |
| GET | `/api/v1/drafting/workspace/v3/matters/{matter_id}/variables` | JWT |
| POST | `/api/v1/drafting/workspace/v3/pack` | JWT |
| GET | `/api/v1/drafting/workspace/v3/search` | JWT |
| GET | `/api/v1/drafting/workspace/v3/templates` | JWT |
| POST | `/api/v1/drafting/workspace/v3/templates/create-document` | JWT |
| POST | `/api/v1/drafting/workspace/v3/templates/render` | JWT |
| GET | `/api/v1/drafting/workspace/v3/workflow` | JWT |

### `POST /api/v1/drafting/redline`
...
### `POST /api/v1/drafting/redline/feedback`
...
### `GET /api/v1/drafting/workspace/documents/{draft_id}/audit`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/autofill`
...
### `GET /api/v1/drafting/workspace/documents/{draft_id}/clause-intel`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/comments/{comment_id}/resolve`
...
### `GET /api/v1/drafting/workspace/documents/{draft_id}/compare-v3`
...
### `PATCH /api/v1/drafting/workspace/documents/{draft_id}/content`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/copilot`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/export-v3`
...
### `GET /api/v1/drafting/workspace/documents/{draft_id}/insights`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/status`
...
### `GET /api/v1/drafting/workspace/v3/matters/{matter_id}/variables`
...
### `POST /api/v1/drafting/workspace/v3/pack`
...
### `GET /api/v1/drafting/workspace/v3/search`
...
### `GET /api/v1/drafting/workspace/v3/templates`
...
### `POST /api/v1/drafting/workspace/v3/templates/create-document`
...
### `POST /api/v1/drafting/workspace/v3/templates/render`
...
### `GET /api/v1/drafting/workspace/v3/workflow`
...
| Method | Full Path | Auth |
|--------|-----------|------|
| GET | `/api/v1/drafting/workspace/documents/{draft_id}/annexures` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/annexures` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/assign` | JWT |
| GET | `/api/v1/drafting/workspace/documents/{draft_id}/assignments` | JWT |
| PATCH | `/api/v1/drafting/workspace/documents/{draft_id}/assignments/{assignment_id}` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/billing-session` | JWT |
| GET | `/api/v1/drafting/workspace/documents/{draft_id}/collaboration-hub` | JWT |
| GET | `/api/v1/drafting/workspace/documents/{draft_id}/compare-precedent` | JWT |
| GET | `/api/v1/drafting/workspace/documents/{draft_id}/filing-readiness` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/insert-annexure-index` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/insert-toc` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/link-hearing` | JWT |
| GET | `/api/v1/drafting/workspace/documents/{draft_id}/links` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/lock` | JWT |
| DELETE | `/api/v1/drafting/workspace/documents/{draft_id}/lock` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/partner-approve` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/partner-review` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/partner-revision` | JWT |
| GET | `/api/v1/drafting/workspace/documents/{draft_id}/presence` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/presence/heartbeat` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/promote-precedent` | JWT |
| GET | `/api/v1/drafting/workspace/documents/{draft_id}/review-workspace` | JWT |
| GET | `/api/v1/drafting/workspace/documents/{draft_id}/signatures` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/signatures` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/signatures/{signature_id}/signed` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/suggestions` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/suggestions/{suggestion_id}/resolve` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/sync-litigation` | JWT |
| GET | `/api/v1/drafting/workspace/documents/{draft_id}/timeline` | JWT |
| GET | `/api/v1/drafting/workspace/documents/{draft_id}/track-changes` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/track-changes` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/track-changes/{change_id}/resolve` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/transition` | JWT |
| GET | `/api/v1/drafting/workspace/v4/control-center` | JWT |
| POST | `/api/v1/drafting/workspace/v4/court-package` | JWT |
| POST | `/api/v1/drafting/workspace/v4/matters/{matter_id}/court-bundle` | JWT |
| GET | `/api/v1/drafting/workspace/v4/matters/{matter_id}/drafting` | JWT |
| GET | `/api/v1/drafting/workspace/v4/matters/{matter_id}/drafting-overview` | JWT |
| POST | `/api/v1/drafting/workspace/v4/matters/{matter_id}/drafts` | JWT |
| GET | `/api/v1/drafting/workspace/v4/precedents` | JWT |
| POST | `/api/v1/drafting/workspace/v4/precedents` | JWT |
| GET | `/api/v1/drafting/workspace/v4/precedents/search` | JWT |

### `GET /api/v1/drafting/workspace/documents/{draft_id}/annexures`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/annexures`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/assign`
...
### `GET /api/v1/drafting/workspace/documents/{draft_id}/assignments`
...
### `PATCH /api/v1/drafting/workspace/documents/{draft_id}/assignments/{assignment_id}`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/billing-session`
...
### `GET /api/v1/drafting/workspace/documents/{draft_id}/collaboration-hub`
...
### `GET /api/v1/drafting/workspace/documents/{draft_id}/compare-precedent`
...
### `GET /api/v1/drafting/workspace/documents/{draft_id}/filing-readiness`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/insert-annexure-index`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/insert-toc`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/link-hearing`
...
### `GET /api/v1/drafting/workspace/documents/{draft_id}/links`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/lock`
...
### `DELETE /api/v1/drafting/workspace/documents/{draft_id}/lock`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/partner-approve`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/partner-review`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/partner-revision`
...
### `GET /api/v1/drafting/workspace/documents/{draft_id}/presence`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/presence/heartbeat`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/promote-precedent`
...
### `GET /api/v1/drafting/workspace/documents/{draft_id}/review-workspace`
...
### `GET /api/v1/drafting/workspace/documents/{draft_id}/signatures`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/signatures`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/signatures/{signature_id}/signed`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/suggestions`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/suggestions/{suggestion_id}/resolve`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/sync-litigation`
...
### `GET /api/v1/drafting/workspace/documents/{draft_id}/timeline`
...
### `GET /api/v1/drafting/workspace/documents/{draft_id}/track-changes`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/track-changes`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/track-changes/{change_id}/resolve`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/transition`
...
### `GET /api/v1/drafting/workspace/v4/control-center`
...
### `POST /api/v1/drafting/workspace/v4/court-package`
...
### `POST /api/v1/drafting/workspace/v4/matters/{matter_id}/court-bundle`
...
### `GET /api/v1/drafting/workspace/v4/matters/{matter_id}/drafting`
...
### `GET /api/v1/drafting/workspace/v4/matters/{matter_id}/drafting-overview`
...
### `POST /api/v1/drafting/workspace/v4/matters/{matter_id}/drafts`
...
### `GET /api/v1/drafting/workspace/v4/precedents`
...
### `POST /api/v1/drafting/workspace/v4/precedents`
...
### `GET /api/v1/drafting/workspace/v4/precedents/search`
...
## Module: drafting_workspace

| Method | Full Path | Auth |
|--------|-----------|------|
| POST | `/api/v1/drafting/workspace/ai/generate` | JWT |
| GET | `/api/v1/drafting/workspace/dashboard` | JWT |
| GET | `/api/v1/drafting/workspace/document-types` | JWT |
| GET | `/api/v1/drafting/workspace/documents` | JWT |
| POST | `/api/v1/drafting/workspace/documents` | JWT |
| GET | `/api/v1/drafting/workspace/documents/{draft_id}` | JWT |
| PATCH | `/api/v1/drafting/workspace/documents/{draft_id}` | JWT |
| DELETE | `/api/v1/drafting/workspace/documents/{draft_id}` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/ai/assist` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/comments` | JWT |
| GET | `/api/v1/drafting/workspace/documents/{draft_id}/compare` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/export` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/restore/{version_number}` | JWT |
| POST | `/api/v1/drafting/workspace/documents/{draft_id}/review` | JWT |
| GET | `/api/v1/drafting/workspace/documents/{draft_id}/versions` | JWT |

### `POST /api/v1/drafting/workspace/ai/generate`
...
### `GET /api/v1/drafting/workspace/dashboard`
...
### `GET /api/v1/drafting/workspace/document-types`
...
### `GET /api/v1/drafting/workspace/documents`
...
### `GET /api/v1/drafting/workspace/documents/{draft_id}`
...
### `PATCH /api/v1/drafting/workspace/documents/{draft_id}`
...
### `DELETE /api/v1/drafting/workspace/documents/{draft_id}`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/ai/assist`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/comments`
...
### `GET /api/v1/drafting/workspace/documents/{draft_id}/compare`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/export`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/restore/{version_number}`
...
### `POST /api/v1/drafting/workspace/documents/{draft_id}/review`
...
### `GET /api/v1/drafting/workspace/documents/{draft_id}/versions`
...
| Method | Full Path | Auth |
|--------|-----------|------|
| GET | `/api/v1/ediscovery/batches` | JWT |
| POST | `/api/v1/ediscovery/batches` | JWT |
| GET | `/api/v1/ediscovery/batches/{batch_id}` | JWT |
| GET | `/api/v1/ediscovery/batches/{batch_id}/search` | JWT |
| POST | `/api/v1/ediscovery/evidence/analyze` | JWT |
| POST | `/api/v1/ediscovery/evidence/contradictions` | JWT |
| POST | `/api/v1/ediscovery/evidence/court-orders` | JWT |
| GET | `/api/v1/ediscovery/evidence/formats` | JWT |
| GET | `/api/v1/ediscovery/evidence/repository` | JWT |
| POST | `/api/v1/ediscovery/evidence/statutes` | JWT |
| GET | `/api/v1/ediscovery/evidence/timeline` | JWT |
| POST | `/api/v1/ediscovery/evidence/upload` | JWT |
| POST | `/api/v1/ediscovery/items/{item_id}/review` | JWT |
| GET | `/api/v1/ediscovery/jobs/{job_id}` | JWT |
| POST | `/api/v1/ediscovery/pii/detect` | JWT |
| POST | `/api/v1/ediscovery/pii/redact` | JWT |
| POST | `/api/v1/ediscovery/pii/whitelist` | JWT |
| POST | `/api/v1/ediscovery/triage` | JWT |

### `GET /api/v1/ediscovery/batches`
...
### `POST /api/v1/ediscovery/batches`
...
### `GET /api/v1/ediscovery/batches/{batch_id}`
...
### `GET /api/v1/ediscovery/batches/{batch_id}/search`
...
### `POST /api/v1/ediscovery/evidence/analyze`
...
### `POST /api/v1/ediscovery/evidence/contradictions`
...
### `POST /api/v1/ediscovery/evidence/court-orders`
...
### `GET /api/v1/ediscovery/evidence/formats`
...
### `GET /api/v1/ediscovery/evidence/repository`
...
### `POST /api/v1/ediscovery/evidence/statutes`
...
### `GET /api/v1/ediscovery/evidence/timeline`
...
### `POST /api/v1/ediscovery/evidence/upload`
...
### `POST /api/v1/ediscovery/items/{item_id}/review`
...
### `GET /api/v1/ediscovery/jobs/{job_id}`
...
### `POST /api/v1/ediscovery/pii/detect`
...
### `POST /api/v1/ediscovery/pii/redact`
...
### `POST /api/v1/ediscovery/pii/whitelist`
...
| Method | Full Path | Auth |
|--------|-----------|------|
| GET | `/api/v1/engines/matters/{matter_id}/autopilot` | JWT |
| GET | `/api/v1/engines/status` | JWT |
| GET | `/api/v1/engines/watchlist` | JWT |
| POST | `/api/v1/engines/watchlist` | JWT |
| DELETE | `/api/v1/engines/watchlist/{watch_id}` | JWT |
| POST | `/api/v1/engines/watchlist/{watch_id}/check` | JWT |

### `GET /api/v1/engines/matters/{matter_id}/autopilot`
...
### `DELETE /api/v1/engines/watchlist/{watch_id}`
...
### `POST /api/v1/engines/watchlist/{watch_id}/check`
...
| Method | Full Path | Auth |
|--------|-----------|------|
| GET | `/api/v1/enterprise/agents` | JWT |
| POST | `/api/v1/enterprise/agents/run` | JWT |
| GET | `/api/v1/enterprise/branding` | JWT |
| GET | `/api/v1/enterprise/court/status` | JWT |
| POST | `/api/v1/enterprise/court/sync` | JWT |
| GET | `/api/v1/enterprise/orgs/{org_id}/branding` | JWT |
| PATCH | `/api/v1/enterprise/orgs/{org_id}/branding` | JWT |
| GET | `/api/v1/enterprise/pilot/firms` | JWT |
| POST | `/api/v1/enterprise/pilot/firms` | JWT |
| PATCH | `/api/v1/enterprise/pilot/firms/{pilot_id}` | JWT |
| GET | `/api/v1/enterprise/pilot/summary` | JWT |
...
### `POST /api/v1/enterprise/agents/run`
...
### `GET /api/v1/enterprise/court/status`
...
### `POST /api/v1/enterprise/court/sync`
...
### `GET /api/v1/enterprise/orgs/{org_id}/branding`
...
### `PATCH /api/v1/enterprise/orgs/{org_id}/branding`
...
### `GET /api/v1/enterprise/pilot/firms`
...
### `POST /api/v1/enterprise/pilot/firms`
...
### `PATCH /api/v1/enterprise/pilot/firms/{pilot_id}`
...
### `GET /api/v1/enterprise/pilot/summary`
...
## Module: enterprise_workspace

| Method | Full Path | Auth |
|--------|-----------|------|
| GET | `/api/v1/enterprise/workspace/analytics` | JWT |
| GET | `/api/v1/enterprise/workspace/audit` | JWT |
| GET | `/api/v1/enterprise/workspace/client-portal` | JWT |
| POST | `/api/v1/enterprise/workspace/client-portal/document-request` | JWT |
| POST | `/api/v1/enterprise/workspace/client-portal/request-review` | JWT |
| GET | `/api/v1/enterprise/workspace/court-orders` | JWT |
| POST | `/api/v1/enterprise/workspace/court-orders` | JWT |
| GET | `/api/v1/enterprise/workspace/court-orders/search` | JWT |
| GET | `/api/v1/enterprise/workspace/court-orders/{order_id}` | JWT |
| GET | `/api/v1/enterprise/workspace/dashboard` | JWT |
| GET | `/api/v1/enterprise/workspace/documents` | JWT |
| POST | `/api/v1/enterprise/workspace/documents` | JWT |
| GET | `/api/v1/enterprise/workspace/documents/search` | JWT |
| GET | `/api/v1/enterprise/workspace/documents/{doc_id}` | JWT |
| GET | `/api/v1/enterprise/workspace/folders` | JWT |
| POST | `/api/v1/enterprise/workspace/folders` | JWT |
| POST | `/api/v1/enterprise/workspace/folders/seed-matter` | JWT |
| GET | `/api/v1/enterprise/workspace/knowledge` | JWT |
| POST | `/api/v1/enterprise/workspace/knowledge` | JWT |
| GET | `/api/v1/enterprise/workspace/matters` | JWT |
| GET | `/api/v1/enterprise/workspace/matters/{matter_id}/hub` | JWT |
| GET | `/api/v1/enterprise/workspace/search` | JWT |
| GET | `/api/v1/enterprise/workspace/storage` | JWT |

### `GET /api/v1/enterprise/workspace/analytics`
...
### `GET /api/v1/enterprise/workspace/audit`
...
### `GET /api/v1/enterprise/workspace/client-portal`
...
### `POST /api/v1/enterprise/workspace/client-portal/document-request`
...
### `POST /api/v1/enterprise/workspace/client-portal/request-review`
...
### `GET /api/v1/enterprise/workspace/court-orders`
...
### `POST /api/v1/enterprise/workspace/court-orders`
...
### `GET /api/v1/enterprise/workspace/court-orders/search`
...
### `GET /api/v1/enterprise/workspace/court-orders/{order_id}`
...
### `GET /api/v1/enterprise/workspace/dashboard`
...
### `GET /api/v1/enterprise/workspace/documents`
...
### `POST /api/v1/enterprise/workspace/documents`
...
### `GET /api/v1/enterprise/workspace/documents/search`
...
### `GET /api/v1/enterprise/workspace/documents/{doc_id}`
...
### `GET /api/v1/enterprise/workspace/folders`
...
### `POST /api/v1/enterprise/workspace/folders`
...
### `POST /api/v1/enterprise/workspace/folders/seed-matter`
...
### `GET /api/v1/enterprise/workspace/knowledge`
...
### `POST /api/v1/enterprise/workspace/knowledge`
...
### `GET /api/v1/enterprise/workspace/matters`
...
### `GET /api/v1/enterprise/workspace/matters/{matter_id}/hub`
...
### `GET /api/v1/enterprise/workspace/search`
...
### `GET /api/v1/enterprise/workspace/storage`
...
| Method | Full Path | Auth |
|--------|-----------|------|
| POST | `/api/v1/esign/mock/{request_id}/complete` | JWT |
| POST | `/api/v1/esign/requests` | JWT |
| GET | `/api/v1/esign/requests/{request_id}` | JWT |

### `POST /api/v1/esign/mock/{request_id}/complete`
...
### `GET /api/v1/esign/requests/{request_id}`
...
| Method | Full Path | Auth |
|--------|-----------|------|
| GET | `/api/v1/feedback-learning/queue` | Superadmin |
| GET | `/api/v1/feedback-learning/queue/mine` | JWT |
| POST | `/api/v1/feedback-learning/queue/{queue_id}/review` | Superadmin |

### `GET /api/v1/feedback-learning/queue`
...
### `GET /api/v1/feedback-learning/queue/mine`
...
### `POST /api/v1/feedback-learning/queue/{queue_id}/review`
...
| GET | `/api/v1/health/embeddings` | JWT |
| GET | `/api/v1/health/gpu` | JWT |
| GET | `/api/v1/health/live` | Public |
| GET | `/api/v1/health/llm` | JWT |
| GET | `/api/v1/health/public` | Public |
| GET | `/api/v1/health/ready` | JWT |
| GET | `/api/v1/metrics` | JWT |
...
| Method | Full Path | Auth |
|--------|-----------|------|
| GET | `/api/v1/ipc-bns/v3/bns/{section}` | JWT |
| POST | `/api/v1/ipc-bns/v3/bulk` | JWT |
| GET | `/api/v1/ipc-bns/v3/categories` | JWT |
| GET | `/api/v1/ipc-bns/v3/categories/{category}` | JWT |
| GET | `/api/v1/ipc-bns/v3/compare/{ipc_section}` | JWT |
| POST | `/api/v1/ipc-bns/v3/convert` | JWT |
| POST | `/api/v1/ipc-bns/v3/document/convert` | JWT |
| POST | `/api/v1/ipc-bns/v3/document/upload` | JWT |
| GET | `/api/v1/ipc-bns/v3/ipc/{section}` | JWT |
| GET | `/api/v1/ipc-bns/v3/matters/{matter_id}/migration` | JWT |
| GET | `/api/v1/ipc-bns/v3/meta` | Public |
| POST | `/api/v1/ipc-bns/v3/report/export` | JWT |
| GET | `/api/v1/ipc-bns/v3/search` | Public |

### `GET /api/v1/ipc-bns/v3/bns/{section}`
...
### `GET /api/v1/ipc-bns/v3/categories`
...
### `GET /api/v1/ipc-bns/v3/categories/{category}`
...
### `GET /api/v1/ipc-bns/v3/compare/{ipc_section}`
...
### `POST /api/v1/ipc-bns/v3/convert`
...
### `POST /api/v1/ipc-bns/v3/document/convert`
...
### `POST /api/v1/ipc-bns/v3/document/upload`
...
### `GET /api/v1/ipc-bns/v3/ipc/{section}`
...
### `GET /api/v1/ipc-bns/v3/matters/{matter_id}/migration`
...
### `POST /api/v1/ipc-bns/v3/report/export`
...
| Method | Full Path | Auth |
|--------|-----------|------|
| GET | `/api/v1/kb/debug-batch` | JWT |
| GET | `/api/v1/kb/debug-query` | JWT |

### `GET /api/v1/kb/debug-batch`
...
| Method | Full Path | Auth |
|--------|-----------|------|
| GET | `/api/v1/learning/analytics/full` | JWT |
| GET | `/api/v1/learning/automation/jobs` | JWT |
| GET | `/api/v1/learning/automation/jobs/{job_id}` | JWT |
| POST | `/api/v1/learning/automation/run-now` | JWT |
| GET | `/api/v1/learning/automation/status` | JWT |
| POST | `/api/v1/learning/correction` | JWT |
| POST | `/api/v1/learning/engine/auto-improve` | JWT |
| POST | `/api/v1/learning/engine/rescue-test` | JWT |
| GET | `/api/v1/learning/engine/status` | JWT |
| POST | `/api/v1/learning/eval/holdout` | JWT |
| POST | `/api/v1/learning/feedback` | JWT |
| GET | `/api/v1/learning/preferences` | JWT |
| GET | `/api/v1/learning/progress` | JWT |
| GET | `/api/v1/learning/quality-gate` | JWT |
| POST | `/api/v1/learning/signals` | JWT |
| GET | `/api/v1/learning/signals/stats` | JWT |
| GET | `/api/v1/learning/signals/tags` | JWT |
| GET | `/api/v1/learning/stats` | JWT |
| POST | `/api/v1/learning/training/export-dpo` | JWT |
| POST | `/api/v1/learning/training/export-sft` | JWT |
| GET | `/api/v1/learning/training/llm-status` | JWT |
| GET | `/api/v1/learning/training/status` | JWT |
| POST | `/api/v1/learning/training/train-dpo` | JWT |
| POST | `/api/v1/learning/training/train-sft` | JWT |
| POST | `/api/v1/learning/tuning/coach/analyze` | JWT |
| POST | `/api/v1/learning/tuning/coach/apply` | JWT |
| GET | `/api/v1/learning/tuning/coach/directives` | JWT |
| POST | `/api/v1/learning/tuning/coach/directives` | JWT |
| POST | `/api/v1/learning/tuning/coach/run` | JWT |
| POST | `/api/v1/learning/tuning/coach/schedule/run-now` | JWT |
| GET | `/api/v1/learning/tuning/coach/schedule/status` | JWT |
| POST | `/api/v1/learning/tuning/coach/schedule/toggle` | JWT |
| GET | `/api/v1/learning/tuning/coach/status` | JWT |
| POST | `/api/v1/learning/tuning/coach/toggle` | JWT |
| POST | `/api/v1/learning/tuning/export` | JWT |
| POST | `/api/v1/learning/tuning/export-saas` | JWT |
| POST | `/api/v1/learning/tuning/neural/collect` | JWT |
| GET | `/api/v1/learning/tuning/neural/status` | JWT |
| POST | `/api/v1/learning/tuning/neural/train` | JWT |
| POST | `/api/v1/learning/tuning/ollama/export-modelfile` | JWT |
| GET | `/api/v1/learning/tuning/ollama/export-status` | JWT |
| POST | `/api/v1/learning/tuning/scope/promote` | JWT |

### `GET /api/v1/learning/analytics/full`
...
### `GET /api/v1/learning/automation/jobs`
...
### `GET /api/v1/learning/automation/jobs/{job_id}`
...
### `POST /api/v1/learning/automation/run-now`
...
### `GET /api/v1/learning/automation/status`
...
### `POST /api/v1/learning/correction`
...
### `POST /api/v1/learning/engine/auto-improve`
...
### `POST /api/v1/learning/engine/rescue-test`
...
### `GET /api/v1/learning/engine/status`
...
### `POST /api/v1/learning/eval/holdout`
...
### `GET /api/v1/learning/quality-gate`
...
### `GET /api/v1/learning/signals/stats`
...
### `GET /api/v1/learning/signals/tags`
...
### `POST /api/v1/learning/training/export-dpo`
...
### `POST /api/v1/learning/training/export-sft`
...
### `GET /api/v1/learning/training/llm-status`
...
### `GET /api/v1/learning/training/status`
...
### `POST /api/v1/learning/training/train-dpo`
...
### `POST /api/v1/learning/training/train-sft`
...
### `POST /api/v1/learning/tuning/coach/analyze`
...
### `POST /api/v1/learning/tuning/coach/apply`
...
### `GET /api/v1/learning/tuning/coach/directives`
...
### `POST /api/v1/learning/tuning/coach/directives`
...
### `POST /api/v1/learning/tuning/coach/run`
...
### `POST /api/v1/learning/tuning/coach/schedule/run-now`
...
### `GET /api/v1/learning/tuning/coach/schedule/status`
...
### `POST /api/v1/learning/tuning/coach/schedule/toggle`
...
### `GET /api/v1/learning/tuning/coach/status`
...
### `POST /api/v1/learning/tuning/coach/toggle`
...
### `POST /api/v1/learning/tuning/export`
...
### `POST /api/v1/learning/tuning/export-saas`
...
### `POST /api/v1/learning/tuning/neural/collect`
...
### `GET /api/v1/learning/tuning/neural/status`
...
### `POST /api/v1/learning/tuning/neural/train`
...
### `POST /api/v1/learning/tuning/ollama/export-modelfile`
...
### `GET /api/v1/learning/tuning/ollama/export-status`
...
### `POST /api/v1/learning/tuning/scope/promote`
...
## Module: legal_conversion

| Method | Full Path | Auth |
|--------|-----------|------|
| GET | `/api/v1/legal-conversion/convert` | JWT |
| POST | `/api/v1/legal-conversion/convert` | JWT |
| GET | `/api/v1/legal-conversion/meta` | Public |
| GET | `/api/v1/legal-conversion/search` | Public |

### `GET /api/v1/legal-conversion/convert`
...
### `POST /api/v1/legal-conversion/convert`
...
### `GET /api/v1/legal-conversion/meta`
...
### `GET /api/v1/legal-conversion/search`
...
| Method | Full Path | Auth |
|--------|-----------|------|
| GET | `/api/v1/matters` | JWT |
| POST | `/api/v1/matters` | JWT |
| GET | `/api/v1/matters/documents/unlinked` | JWT |
| GET | `/api/v1/matters/evidence-desk` | JWT |
| POST | `/api/v1/matters/evidence-desk/scan` | JWT |
| GET | `/api/v1/matters/health/indexing` | JWT |
| GET | `/api/v1/matters/hearings/digest` | JWT |
| GET | `/api/v1/matters/meta/types` | JWT |
| GET | `/api/v1/matters/notifications/all` | JWT |
| DELETE | `/api/v1/matters/{matter_id}` | JWT |
| GET | `/api/v1/matters/{matter_id}` | JWT |
| PATCH | `/api/v1/matters/{matter_id}` | JWT |
| GET | `/api/v1/matters/{matter_id}/audit` | JWT |
| GET | `/api/v1/matters/{matter_id}/autopilot` | JWT |
| GET | `/api/v1/matters/{matter_id}/client-status-letter` | JWT |
| GET | `/api/v1/matters/{matter_id}/contradictions` | JWT |
| POST | `/api/v1/matters/{matter_id}/contradictions/extract` | JWT |
| GET | `/api/v1/matters/{matter_id}/dashboard` | JWT |
| GET | `/api/v1/matters/{matter_id}/deadlines` | JWT |
| POST | `/api/v1/matters/{matter_id}/deadlines` | JWT |
| POST | `/api/v1/matters/{matter_id}/documents/link` | JWT |
| POST | `/api/v1/matters/{matter_id}/documents/upload` | JWT |
| PATCH | `/api/v1/matters/{matter_id}/documents/{document_id}` | JWT |
| GET | `/api/v1/matters/{matter_id}/entities` | JWT |
| POST | `/api/v1/matters/{matter_id}/entities/extract` | JWT |
| GET | `/api/v1/matters/{matter_id}/entities/profiles` | JWT |
| GET | `/api/v1/matters/{matter_id}/evidence` | JWT |
| POST | `/api/v1/matters/{matter_id}/evidence` | JWT |
| POST | `/api/v1/matters/{matter_id}/evidence/extract` | JWT |
| GET | `/api/v1/matters/{matter_id}/export` | JWT |
| GET | `/api/v1/matters/{matter_id}/hearing-prep-pack` | JWT |
| GET | `/api/v1/matters/{matter_id}/hearings` | JWT |
| POST | `/api/v1/matters/{matter_id}/hearings` | JWT |
| POST | `/api/v1/matters/{matter_id}/hearings/extract` | JWT |
| POST | `/api/v1/matters/{matter_id}/hearings/from-voice` | JWT |
| POST | `/api/v1/matters/{matter_id}/hearings/import-cause-list` | JWT |
| POST | `/api/v1/matters/{matter_id}/intelligence/run` | JWT |
| GET | `/api/v1/matters/{matter_id}/intelligence/status` | JWT |
| GET | `/api/v1/matters/{matter_id}/members` | JWT |
| POST | `/api/v1/matters/{matter_id}/members` | JWT |
| POST | `/api/v1/matters/{matter_id}/notes` | JWT |
| POST | `/api/v1/matters/{matter_id}/restore` | JWT |
| GET | `/api/v1/matters/{matter_id}/search` | JWT |
| POST | `/api/v1/matters/{matter_id}/smoke` | JWT |
| GET | `/api/v1/matters/{matter_id}/tasks` | JWT |
| POST | `/api/v1/matters/{matter_id}/tasks` | JWT |
| PATCH | `/api/v1/matters/{matter_id}/tasks/{task_id}` | JWT |
| GET | `/api/v1/matters/{matter_id}/timeline` | JWT |
| POST | `/api/v1/matters/{matter_id}/timeline` | JWT |
| POST | `/api/v1/matters/{matter_id}/timeline/generate` | JWT |
| GET | `/api/v1/matters/{matter_id}/timeline/suggestions` | JWT |
| POST | `/api/v1/matters/{matter_id}/timeline/suggestions/{suggestion_id}/approve` | JWT |
| POST | `/api/v1/matters/{matter_id}/timeline/suggestions/{suggestion_id}/reject` | JWT |
...
### `GET /api/v1/matters/documents/unlinked`
...
### `GET /api/v1/matters/evidence-desk`
...
### `POST /api/v1/matters/evidence-desk/scan`
...
### `GET /api/v1/matters/health/indexing`
...
### `GET /api/v1/matters/hearings/digest`
...
### `GET /api/v1/matters/notifications/all`
...
### `GET /api/v1/matters/{matter_id}/audit`
...
### `GET /api/v1/matters/{matter_id}/autopilot`
...
### `GET /api/v1/matters/{matter_id}/client-status-letter`
...
### `GET /api/v1/matters/{matter_id}/contradictions`
...
### `POST /api/v1/matters/{matter_id}/contradictions/extract`
...
### `GET /api/v1/matters/{matter_id}/dashboard`
...
### `GET /api/v1/matters/{matter_id}/deadlines`
...
### `POST /api/v1/matters/{matter_id}/deadlines`
...
### `POST /api/v1/matters/{matter_id}/documents/link`
...
### `POST /api/v1/matters/{matter_id}/documents/upload`
...
### `PATCH /api/v1/matters/{matter_id}/documents/{document_id}`
...
### `GET /api/v1/matters/{matter_id}/entities`
...
### `POST /api/v1/matters/{matter_id}/entities/extract`
...
### `GET /api/v1/matters/{matter_id}/entities/profiles`
...
### `GET /api/v1/matters/{matter_id}/evidence`
...
### `POST /api/v1/matters/{matter_id}/evidence`
...
### `POST /api/v1/matters/{matter_id}/evidence/extract`
...
### `GET /api/v1/matters/{matter_id}/export`
...
### `GET /api/v1/matters/{matter_id}/hearing-prep-pack`
...
### `GET /api/v1/matters/{matter_id}/hearings`
...
### `POST /api/v1/matters/{matter_id}/hearings`
...
### `POST /api/v1/matters/{matter_id}/hearings/extract`
...
### `POST /api/v1/matters/{matter_id}/hearings/from-voice`
...
### `POST /api/v1/matters/{matter_id}/hearings/import-cause-list`
...
### `POST /api/v1/matters/{matter_id}/intelligence/run`
...
### `GET /api/v1/matters/{matter_id}/intelligence/status`
...
### `POST /api/v1/matters/{matter_id}/restore`
...
### `GET /api/v1/matters/{matter_id}/search`
...
### `POST /api/v1/matters/{matter_id}/smoke`
...
### `GET /api/v1/matters/{matter_id}/tasks`
...
### `POST /api/v1/matters/{matter_id}/tasks`
...
### `PATCH /api/v1/matters/{matter_id}/tasks/{task_id}`
...
### `POST /api/v1/matters/{matter_id}/timeline`
...
### `POST /api/v1/matters/{matter_id}/timeline/generate`
...
### `GET /api/v1/matters/{matter_id}/timeline/suggestions`
...
### `POST /api/v1/matters/{matter_id}/timeline/suggestions/{suggestion_id}/approve`
...
### `POST /api/v1/matters/{matter_id}/timeline/suggestions/{suggestion_id}/reject`
...
| Method | Full Path | Auth |
|--------|-----------|------|
| GET | `/api/v1/memory/context` | JWT |
| POST | `/api/v1/memory/facts` | JWT |
| POST | `/api/v1/memory/facts/reindex-chats` | JWT |
| PATCH | `/api/v1/memory/facts/{fact_id}` | JWT |
| DELETE | `/api/v1/memory/facts/{fact_id}` | JWT |
| GET | `/api/v1/memory/profile` | JWT |
| PATCH | `/api/v1/memory/profile` | JWT |
...
### `POST /api/v1/memory/facts/reindex-chats`
...
| Method | Full Path | Auth |
|--------|-----------|------|
| POST | `/api/v1/orgs/invite` | JWT |
| GET | `/api/v1/orgs/invites` | JWT |
| DELETE | `/api/v1/orgs/invites/{invite_id}` | JWT |
| GET | `/api/v1/orgs/invites/{token}` | JWT |
| POST | `/api/v1/orgs/invites/{token}/accept` | JWT |
| GET | `/api/v1/orgs/me` | JWT |
...
### `DELETE /api/v1/orgs/invites/{invite_id}`
...
| Method | Full Path | Auth |
|--------|-----------|------|
| POST | `/api/v1/portal/access` | JWT |
| POST | `/api/v1/portal/sign/{token}` | Portal token |
| POST | `/api/v1/portal/upload/{token}` | Portal token |
| GET | `/api/v1/portal/view/{token}` | Portal token |
...
### `POST /api/v1/portal/upload/{token}`
...
| Method | Full Path | Auth |
|--------|-----------|------|
| GET | `/api/v1/practice/court-day/calendar.ics` | JWT |
| POST | `/api/v1/practice/court-day/import` | JWT |
| GET | `/api/v1/practice/court-day/mission-control` | JWT |
| POST | `/api/v1/practice/court-day/parse` | JWT |
| POST | `/api/v1/practice/court-day/parse-file` | JWT |
| GET | `/api/v1/practice/court-day/prep/{matter_id}` | JWT |
| GET | `/api/v1/practice/court-day/prep/{matter_id}/pdf` | JWT |
| GET | `/api/v1/practice/court-day/today` | JWT |
| POST | `/api/v1/practice/court-sync` | JWT |
| GET | `/api/v1/practice/court-sync/history` | JWT |
| GET | `/api/v1/practice/court-sync/settings` | JWT |
| PUT | `/api/v1/practice/court-sync/settings` | JWT |
| GET | `/api/v1/practice/court-sync/status` | JWT |
| GET | `/api/v1/practice/ecourts/case/{cnr}` | JWT |
| POST | `/api/v1/practice/ecourts/case/{cnr}/sync` | JWT |
| GET | `/api/v1/practice/ecourts/causelist/available-dates` | JWT |
| GET | `/api/v1/practice/ecourts/court-structure/states` | JWT |
| GET | `/api/v1/practice/ecourts/court-structure/states/{state}/districts` | JWT |
| GET | `/api/v1/practice/ecourts/search` | JWT |
| GET | `/api/v1/practice/evidence-desk` | JWT |
| GET | `/api/v1/practice/evidence-desk/export` | JWT |
| POST | `/api/v1/practice/evidence-desk/scan` | JWT |
| POST | `/api/v1/practice/evidence-desk/scan-all` | JWT |
| POST | `/api/v1/practice/limitation/add-to-matter` | JWT |
| POST | `/api/v1/practice/limitation/calculate` | JWT |
| GET | `/api/v1/practice/limitation/presets` | JWT |
| POST | `/api/v1/practice/litigation/ai` | JWT |
| GET | `/api/v1/practice/litigation/analytics` | JWT |
| GET | `/api/v1/practice/litigation/calendar` | JWT |
| GET | `/api/v1/practice/litigation/dashboard` | JWT |
| GET | `/api/v1/practice/litigation/diagnostics` | JWT |
| GET | `/api/v1/practice/litigation/hearings` | JWT |
| POST | `/api/v1/practice/litigation/hearings` | JWT |
| PATCH | `/api/v1/practice/litigation/hearings/{hearing_id}` | JWT |
| GET | `/api/v1/practice/litigation/limitation/deadlines` | JWT |
| GET | `/api/v1/practice/litigation/notifications` | JWT |
| GET | `/api/v1/practice/litigation/orders` | JWT |
| POST | `/api/v1/practice/litigation/orders` | JWT |
| PATCH | `/api/v1/practice/litigation/orders/{order_id}` | JWT |
| DELETE | `/api/v1/practice/litigation/orders/{order_id}` | JWT |
| GET | `/api/v1/practice/litigation/tasks` | JWT |
| POST | `/api/v1/practice/litigation/tasks` | JWT |
| PATCH | `/api/v1/practice/litigation/tasks/{task_id}` | JWT |
| DELETE | `/api/v1/practice/litigation/tasks/{task_id}` | JWT |
| GET | `/api/v1/practice/litigation/war-room/{matter_id}` | JWT |
| GET | `/api/v1/practice/litigation/watchlist-dashboard` | JWT |
| GET | `/api/v1/practice/overview` | JWT |
| POST | `/api/v1/practice/public-intake` | JWT |

### `GET /api/v1/practice/court-day/calendar.ics`
...
### `POST /api/v1/practice/court-day/import`
...
### `GET /api/v1/practice/court-day/mission-control`
...
### `POST /api/v1/practice/court-day/parse`
...
### `POST /api/v1/practice/court-day/parse-file`
...
### `GET /api/v1/practice/court-day/prep/{matter_id}`
...
### `GET /api/v1/practice/court-day/prep/{matter_id}/pdf`
...
### `GET /api/v1/practice/court-day/today`
...
### `POST /api/v1/practice/court-sync`
...
### `GET /api/v1/practice/court-sync/history`
...
### `GET /api/v1/practice/court-sync/settings`
...
### `PUT /api/v1/practice/court-sync/settings`
...
### `GET /api/v1/practice/court-sync/status`
...
### `GET /api/v1/practice/ecourts/case/{cnr}`
...
### `POST /api/v1/practice/ecourts/case/{cnr}/sync`
...
### `GET /api/v1/practice/ecourts/causelist/available-dates`
...
### `GET /api/v1/practice/ecourts/court-structure/states`
...
### `GET /api/v1/practice/ecourts/court-structure/states/{state}/districts`
...
### `GET /api/v1/practice/ecourts/search`
...
### `GET /api/v1/practice/evidence-desk`
...
### `GET /api/v1/practice/evidence-desk/export`
...
### `POST /api/v1/practice/evidence-desk/scan`
...
### `POST /api/v1/practice/evidence-desk/scan-all`
...
### `POST /api/v1/practice/limitation/add-to-matter`
...
### `POST /api/v1/practice/limitation/calculate`
...
### `GET /api/v1/practice/limitation/presets`
...
### `POST /api/v1/practice/litigation/ai`
...
### `GET /api/v1/practice/litigation/analytics`
...
### `GET /api/v1/practice/litigation/calendar`
...
### `GET /api/v1/practice/litigation/dashboard`
...
### `GET /api/v1/practice/litigation/diagnostics`
...
### `GET /api/v1/practice/litigation/hearings`
...
### `POST /api/v1/practice/litigation/hearings`
...
### `PATCH /api/v1/practice/litigation/hearings/{hearing_id}`
...
### `GET /api/v1/practice/litigation/limitation/deadlines`
...
### `GET /api/v1/practice/litigation/notifications`
...
### `GET /api/v1/practice/litigation/orders`
...
### `POST /api/v1/practice/litigation/orders`
...
### `PATCH /api/v1/practice/litigation/orders/{order_id}`
...
### `DELETE /api/v1/practice/litigation/orders/{order_id}`
...
### `GET /api/v1/practice/litigation/tasks`
...
### `POST /api/v1/practice/litigation/tasks`
...
### `PATCH /api/v1/practice/litigation/tasks/{task_id}`
...
### `DELETE /api/v1/practice/litigation/tasks/{task_id}`
...
### `GET /api/v1/practice/litigation/war-room/{matter_id}`
...
### `GET /api/v1/practice/litigation/watchlist-dashboard`
...
### `POST /api/v1/practice/public-intake`
...
| Method | Full Path | Auth |
|--------|-----------|------|
| POST | `/api/v1/research/expand` | JWT |
| POST | `/api/v1/research/feedback` | JWT |
| GET | `/api/v1/research/history` | JWT |
| POST | `/api/v1/research/log` | JWT |

### `POST /api/v1/research/expand`
...
| Method | Full Path | Auth |
|--------|-----------|------|
| GET | `/api/v1/saas-metrics/kpi` | JWT |

### `GET /api/v1/saas-metrics/kpi`
...
| Method | Full Path | Auth |
|--------|-----------|------|
| GET | `/api/v1/scim/v2/Users` | Public |
| POST | `/api/v1/scim/v2/Users` | JWT |
...
| Method | Full Path | Auth |
|--------|-----------|------|
| GET | `/api/v1/sessions/by-id/{session_id}` | JWT |
| GET | `/api/v1/sessions/history` | JWT |
| DELETE | `/api/v1/sessions/history` | JWT |
| DELETE | `/api/v1/sessions/threads/{thread_id}` | JWT |
| GET | `/api/v1/sessions/threads/{thread_id}` | JWT |
| GET | `/api/v1/sessions/threads/{thread_id}/attachment` | JWT |
| POST | `/api/v1/sessions/threads/{thread_id}/attachment` | JWT |
| DELETE | `/api/v1/sessions/threads/{thread_id}/attachment` | JWT |
...
### `DELETE /api/v1/sessions/threads/{thread_id}`
...
### `GET /api/v1/sessions/threads/{thread_id}`
...
### `GET /api/v1/sessions/threads/{thread_id}/attachment`
...
### `POST /api/v1/sessions/threads/{thread_id}/attachment`
...
### `DELETE /api/v1/sessions/threads/{thread_id}/attachment`
...
| Method | Full Path | Auth |
|--------|-----------|------|
| POST | `/api/v1/speech/polish` | JWT |
| GET | `/api/v1/speech/status` | JWT |
| POST | `/api/v1/speech/transcribe` | JWT |

### `POST /api/v1/speech/polish`
...
| Method | Full Path | Auth |
|--------|-----------|------|
| POST | `/api/v1/sso/callback` | JWT |
| GET | `/api/v1/sso/login` | Public |
| GET | `/api/v1/sso/status` | JWT |
...
| Method | Full Path | Auth |
|--------|-----------|------|
| GET | `/api/v1/subscriptions/payments` | JWT |
| GET | `/api/v1/subscriptions/plans` | Public |
| GET | `/api/v1/subscriptions/portal` | JWT |
...
| GET | `/api/v1/templates/{template_id}` | JWT |
| POST | `/api/v1/templates/{template_id}/generate` | JWT |
...
| Method | Full Path | Auth |
|--------|-----------|------|
| GET | `/api/v1/trust/account` | JWT |
| GET | `/api/v1/trust/transactions` | JWT |
| POST | `/api/v1/trust/transactions` | JWT |

### `GET /api/v1/trust/account`
...
### `POST /api/v1/trust/transactions`
...
# Appendix W — Complete Database Table Reference

Every production table with purpose and primary columns. Foreign keys enforce matter and user scoping.

## Table: `users`

**Purpose:** Core auth

**Columns:** id PK, username UNIQUE, password_hash, membership, role, email, suspended, created_at

**Relationships:** All tables scoped by user_id and/or matter_id. Enterprise ent_* tables link to matters optionally. Discovery items cascade delete with batch.

**Indexes:** Created on user_id, matter_id, thread_id, batch_id where query patterns require.

## Table: `organizations`

**Purpose:** Multi-tenant

**Columns:** org_id PK, name, plan, seat_limit, custom_domain, logo_url
...
**Columns:** org_id, user_id, role, UNIQUE(org_id,user_id)
...
**Columns:** matter_id PK, user_id, matter_name, practice_area, client_name, venue, status_tier
...
**Columns:** hearing_id, matter_id FK, hearing_date, court, item_number, bench
...
**Columns:** task_id, matter_id FK, title, assignee, due_date, status

**Relationships:** All tables scoped by user_id and/or matter_id. Enterprise ent_* tables link to matters optionally. Discovery items cascade delete with batch.

**Indexes:** Created on user_id, matter_id, thread_id, batch_id where query patterns require.

## Table: `matter_timeline`

**Purpose:** Chronology

**Columns:** event_id, matter_id FK, event_date, description, source

**Relationships:** All tables scoped by user_id and/or matter_id. Enterprise ent_* tables link to matters optionally. Discovery items cascade delete with batch.

**Indexes:** Created on user_id, matter_id, thread_id, batch_id where query patterns require.

## Table: `matter_entities`

**Purpose:** Parties

**Columns:** entity_id, matter_id FK, entity_type, name, role

**Relationships:** All tables scoped by user_id and/or matter_id. Enterprise ent_* tables link to matters optionally. Discovery items cascade delete with batch.

**Indexes:** Created on user_id, matter_id, thread_id, batch_id where query patterns require.

## Table: `matter_evidence`

**Purpose:** Evidence

**Columns:** evidence_id, matter_id FK, document_id, description

**Relationships:** All tables scoped by user_id and/or matter_id. Enterprise ent_* tables link to matters optionally. Discovery items cascade delete with batch.

**Indexes:** Created on user_id, matter_id, thread_id, batch_id where query patterns require.

## Table: `matter_contradictions`

**Purpose:** Analysis

**Columns:** id, matter_id FK, doc_a, doc_b, conflict_type, detail
...
**Columns:** doc_id PK, user_id, filename, matter_id, indexed, chunk_count
...
**Columns:** id PK, user_id, question, answer, mode, thread_id, matter_id

**Relationships:** All tables scoped by user_id and/or matter_id. Enterprise ent_* tables link to matters optionally. Discovery items cascade delete with batch.

**Indexes:** Created on user_id, matter_id, thread_id, batch_id where query patterns require.

## Table: `adaptive_interactions`

**Purpose:** Learning

**Columns:** id PK, user_id, mode, query, chunk_keys, found_in_kb

**Relationships:** All tables scoped by user_id and/or matter_id. Enterprise ent_* tables link to matters optionally. Discovery items cascade delete with batch.

**Indexes:** Created on user_id, matter_id, thread_id, batch_id where query patterns require.

## Table: `adaptive_feedback`

**Purpose:** Feedback

**Columns:** id PK, interaction_id, signal, value, tags_json
...
**Columns:** draft_id PK, user_id, matter_id, title, status, content_html

**Relationships:** All tables scoped by user_id and/or matter_id. Enterprise ent_* tables link to matters optionally. Discovery items cascade delete with batch.

**Indexes:** Created on user_id, matter_id, thread_id, batch_id where query patterns require.

## Table: `workspace_draft_versions`

**Purpose:** Versions

**Columns:** draft_id FK, version_number, content_html, created_at
...
**Columns:** lead_id PK, user_id, pipeline_stage, lead_score, analysis_json
...
**Columns:** record_id PK, matter_id, hours, rate, narrative
...
**Columns:** invoice_id PK, user_id, matter_id, status, total_inr

**Relationships:** All tables scoped by user_id and/or matter_id. Enterprise ent_* tables link to matters optionally. Discovery items cascade delete with batch.

**Indexes:** Created on user_id, matter_id, thread_id, batch_id where query patterns require.

## Table: `ediscovery_batches`

**Purpose:** Evidence Intel

**Columns:** batch_id PK, matter_id, user_id, batch_title
...
**Columns:** item_id PK, batch_id FK, metadata_json, entities_json, timeline_json
...
**Columns:** account_id PK, matter_id, trust_balance, operating_balance

**Relationships:** All tables scoped by user_id and/or matter_id. Enterprise ent_* tables link to matters optionally. Discovery items cascade delete with batch.

**Indexes:** Created on user_id, matter_id, thread_id, batch_id where query patterns require.

## Table: `ent_court_orders`

**Purpose:** Enterprise

**Columns:** order_id PK, user_id, case_number, court, content_text
...
**Columns:** entry_id PK, user_id, entry_type, title, content_text

**Relationships:** All tables scoped by user_id and/or matter_id. Enterprise ent_* tables link to matters optionally. Discovery items cascade delete with batch.

**Indexes:** Created on user_id, matter_id, thread_id, batch_id where query patterns require.

## Table: `ent_dms_documents`

**Purpose:** Enterprise DMS

**Columns:** doc_id PK, folder_id, filename, ocr_text, tags_json
...
**Columns:** room_id PK, org_id, matter_id, room_type, name
...
**Columns:** message_id PK, room_id FK, user_id, body, created_at
...
# Appendix X — API Request/Response Examples (Detailed)
...
**Request:**
```json
{"username":"adv1","password":"Pass123!","confirm_password":"Pass123!","accept_terms":true}
```
...
**Authentication:** Bearer JWT required except public auth routes.

**Validation errors (422):** Missing required fields return Pydantic detail array.
...
**Request:**
```json
{"username":"adv1","password":"Pass123!"}
```

**Response (200):**
```json
{"token":"jwt...","membership":"Pro"}
```
...
**Request:**
```json
{"message":"Section 302 IPC","mode":"knowledge_base","lang":"English"}
```

**Response (200):**
```json
{"content":"...","interaction_id":"uuid","follow_ups":[]}
```
...
**Endpoint:** `POST /api/v1/matters`

**Request:**
```json
{"matter_name":"State v X","practice_area":"Criminal"}
```
...
**Endpoint:** `GET /api/v1/matters/{id}/timeline`
...
**Request:**
```json
{"signal":"thumbs_up","interaction_id":"uuid"}
```
...
**Endpoint:** `POST /api/v1/ediscovery/evidence/upload`
...
**Endpoint:** `GET /api/v1/ipc-bns/v3/search`
...
**Endpoint:** `POST /api/v1/crm`

**Request:**
```json
{"client_name":"X","phone":"9876543210"}
```
...
**Endpoint:** `POST /api/v1/billing/entries`

**Request:**
```json
{"matter_id":"uuid","hours":2,"narrative":"Draft"}
```
...
**Endpoint:** `POST /api/v1/drafting/workspace/documents`

**Request:**
```json
{"title":"Bail App","matter_id":"uuid"}
```
...
**Endpoint:** `GET /api/v1/enterprise/workspace/court-orders`
...
**Endpoint:** `POST /api/v1/collaboration/rooms/channel`
...
**Endpoint:** `POST /api/v1/portal/access`
...
**Endpoint:** `GET /api/v1/practice/court-day/mission-control`
...
# Appendix Y — Competitive Analysis (Extended Narrative)

## Harvey AI

Harvey targets Am Law 100 firms with general-purpose legal LLM assistance. Strengths include brand recognition, partnership with OpenAI, and workflow integrations with elite firms. Weaknesses for Indian market: no IPC-BNS migration tooling, no cause list integration, no INR billing/trust accounting, pricing inaccessible to SMB firms. LegalEase competes by offering India-specific statute intelligence, matter-scoped RAG, and integrated practice ops at SaaS price points Harvey cannot match for solo and small firm segments.

## Relativity

Relativity is the gold standard for enterprise e-discovery at scale — processing terabytes with distributed OCR, review workflows, and production sets. LegalEase Evidence Intelligence Center targets a different segment: Indian SMB firms needing OCR, entity extraction, BNS statute mapping, and matter linkage without six-figure Relativity licenses. Our workflow mirrors investigation patterns (upload, classify, timeline, contradict) without requiring dedicated review attorney staffing.

## Everlaw and DISCO

Cloud e-discovery platforms focused on US litigation. Strong storyboarding and deposition tools. No Indian legal corpus, no hybrid AI assistant for statutory research. LegalEase integrates discovery with the same AI Assistant that answers legal questions — a unified investigation and research surface.

## Clio and MyCase

Practice management leaders for SMB law. Excellent matter, billing, and client communication. Minimal AI — no document-grounded chat, no evidence classification, no adaptive learning. LegalEase is AI-first with PM features rather than PM-first with bolt-on AI.

## LexisNexis and Westlaw

Authoritative research databases with decades of Indian and international content. Expensive subscriptions, not integrated with firm uploaded documents. LegalEase complements (not replaces) research databases by grounding answers in the firm's own case files while offering Open Law web research for live developments.

## Feature Matrix (Extended)

| Capability | LegalEase | Harvey | Relativity | Clio | Lexis |
|------------|-----------|--------|------------|------|-------|
| Document RAG | Yes | Partial | No | No | No |
| Matter-scoped AI | Yes | Partial | No | No | No |
| IPC-BNS engine | Yes | No | No | No | Partial |
| Evidence OCR upload | Yes | No | Yes | No | No |
| Entity extraction | Yes | Partial | Yes | No | No |
| Timeline builder | Yes | No | Yes | No | No |
| BNS statute suggest | Yes | No | No | No | Partial |
| Contradiction detect | Yes | No | Partial | No | No |
| Privilege flags | Yes | Yes | Yes | No | No |
| Drafting studio | Yes | Yes | No | Basic | No |
| CRM intake | Yes | No | No | Yes | No |
| Trust accounting | Yes | No | No | Partial | No |
| Cause list import | Yes | No | No | No | No |
| Firm chat | Yes | No | No | Add-on | No |
| Adaptive learning | Yes | Unknown | No | No | No |
| Client portal | Yes | No | No | Yes | No |
| India pricing (SMB) | Yes | No | No | Yes | Partial |


---

# Appendix Z — AI System Design (Interview-Grade Detail)

## Z.1 Knowledge Base Mode — Full Trace

Step 1: User submits query via POST /api/v1/chat with mode=knowledge_base.
Step 2: chat_service.resolve_chat_route normalizes mode alias.
Step 3: matter_policy.validate_chat_scope checks matter access if scoped.
Step 4: intent_engine and query_parser detect section numbers, comparison intent, summary intent.
Step 5: kb_pipeline orchestrates: retrieve, rerank, filter, aggregate, generate, validate.
Step 6: kb_retrieval_coordinator runs semantic search then keyword fallback on FAISS index.
Step 7: rag.py hybrid dense+sparse+MMR retrieval with optional cross-encoder rerank.
Step 8: kb_gemini_safety blocks any Gemini synthesis — Ollama only.
Step 9: llms.py get_generator uses OLLAMA_MODEL (legalease-tuned) for synthesis.
Step 10: answer_orchestrator formats response with citations from chunk metadata.
Step 11: adaptive_learning.record_interaction logs turn with chunk_keys for feedback.
Step 12: chat_persistence saves to chat_history and returns interaction_id.

## Z.2 Open Law Mode — Provider Chain

Primary: web_intelligence.py Gemini grounded Google Search.
Fallback 1: Tavily/SerpAPI via open_law_executor legacy web search.
Fallback 2: OpenRouter API.
Fallback 3: DeepSeek API.
Fallback 4: Qwen/DashScope API.
Fallback 5: Local Ollama via llm_orchestrator.legal_reason().
Never raises — always returns best-effort answer with web_sources array.

## Z.3 Hybrid Mode

hybrid_orchestrator.run_hybrid_turn retrieves KB chunks AND web results, fuses in single prompt.
Requires Pro/Legal Pro membership unless SAAS_ALL_FEATURES_FREE=1.

## Z.4 Feedback Learning Loop

Thumbs up triggers: adaptive_chunk_boosts update, query pattern success increment, optional neural pair collection, learn_from_kb_success or learn_from_web_success, background coach and improvement automation scheduling.

## Z.5 Evidence Intelligence (Non-LLM Classification)

Rule-based classification ensures predictable tags on EC2 CPU without GPU inference cost.
Entity extraction via regex for Indian phone, IFSC, case numbers, cities.
Statute mapping via pattern rules to BNS 316, 318, 336, 61.
Future v2: optional Gemini enrichment for privilege review (roadmap).
